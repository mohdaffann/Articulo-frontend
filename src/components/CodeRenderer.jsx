...
export const CodeRenderer = ({ data }) => {
    ...
    return (
        <div className="flex max-w-full mt-6 px-4 py-6 flex-col  bg-gray-100    rounded-lg ">
                        ...
                        <div key={ind} className="flex ">
                            {
                                data.showlinenumbers && (
                                    <span className="text-gray-500 mr-4 select-none text-[19px] text-right inline-block">{ind + 1}</span>

                                )
                            }
                            <code className="flex-1 text-[15px] mb-1.5">
                                {item}
                            </code>
                        </div>
                    ))
